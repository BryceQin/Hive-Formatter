...
<body>
                ...
                <div class="section-body">
                    ...
                    <div class="config-group">
                        ...
                        <div class="cg-body open">
                            ...
                            <div class="config-item">
                                <div class="ci-label"><span class="ci-label-text">NULL 大小写</span></div>
                                <select class="config-select" id="nullCase">
                                    <option value="preserve">保持原样</option>
                                    <option value="upper">大写</option>
                                    <option value="lower">小写</option>
                                </select>
                            ...
                            <div class="config-item">
                                <div class="ci-label"><span class="ci-label-text">布尔值大小写</span></div>
                                <select class="config-select" id="booleanCase">
                                    <option value="preserve">保持原样</option>
                                    <option value="upper">大写</option>
                                    <option value="lower">小写</option>
                                </select>
                    ...
                    <div class="config-group">
                        ...
                        <div class="cg-body open">
                            ...
                            <div class="toggle-row"><span class="toggle-label">GROUP BY 后换行</span><label class="toggle"><input type="checkbox" id="newlineAfterGroupBy"><span class="toggle-slider"></span></label></div>
                            <div class="toggle-row"><span class="toggle-label">HAVING 后换行</span><label class="toggle"><input type="checkbox" id="newlineAfterHaving"><span class="toggle-slider"></span></label></div>
                            <div class="toggle-row"><span class="toggle-label">ORDER BY 后换行</span><label class="toggle"><input type="checkbox" id="newlineAfterOrderBy"><span class="toggle-slider"></span></label></div>
                            <div class="toggle-row"><span class="toggle-label">LIMIT 后换行</span><label class="toggle"><input type="checkbox" id="newlineAfterLimit"><span class="toggle-slider"></span></label></div>
                            <div class="toggle-row"><span class="toggle-label">JOIN 后换行</span><label class="toggle"><input type="checkbox" id="newlineAfterJoin"><span class="toggle-slider"></span></label></div>
                            <div class="toggle-row"><span class="toggle-label">ON 前换行</span><label class="toggle"><input type="checkbox" id="newlineBeforeOn"><span class="toggle-slider"></span></label></div>
                            <div class="toggle-row"><span class="toggle-label">UNION 前换行</span><label class="toggle"><input type="checkbox" id="newlineBeforeSetOperation"><span class="toggle-slider"></span></label></div>
                            <div class="toggle-row"><span class="toggle-label">CASE 后换行</span><label class="toggle"><input type="checkbox" id="newlineAfterCase"><span class="toggle-slider"></span></label></div>
                            <div class="toggle-row"><span class="toggle-label">WHEN 后换行</span><label class="toggle"><input type="checkbox" id="newlineAfterWhen"><span class="toggle-slider"></span></label></div>
                            <div class="toggle-row"><span class="toggle-label">THEN 后换行</span><label class="toggle"><input type="checkbox" id="newlineAfterThen"><span class="toggle-slider"></span></label></div>
                            <div class="toggle-row"><span class="toggle-label">ELSE 后换行</span><label class="toggle"><input type="checkbox" id="newlineAfterElse"><span class="toggle-slider"></span></label></div>
                            <div class="toggle-row"><span class="toggle-label">IN 后换行</span><label class="toggle"><input type="checkbox" id="newlineAfterIn"><span class="toggle-slider"></span></label></div>
                        </div>
                    </div>
                    ...
                    <div class="config-group">
                        ...
                        <div class="cg-body">
                            ...
                            <div class="toggle-row"><span class="toggle-label">JOIN 条件缩进</span><label class="toggle"><input type="checkbox" id="indentJoinConditions"><span class="toggle-slider"></span></label></div>
                            <div class="toggle-row"><span class="toggle-label">WHEN 缩进</span><label class="toggle"><input type="checkbox" id="indentWhen"><span class="toggle-slider"></span></label></div>
                            <div class="toggle-row"><span class="toggle-label">THEN 缩进</span><label class="toggle"><input type="checkbox" id="indentThen"><span class="toggle-slider"></span></label></div>
                            <div class="toggle-row"><span class="toggle-label">CTE 体缩进</span><label class="toggle"><input type="checkbox" id="indentCteBody"><span class="toggle-slider"></span></label></div>
                            <div class="toggle-row"><span class="toggle-label">对齐 ON 条件</span><label class="toggle"><input type="checkbox" id="alignOnClauses"><span class="toggle-slider"></span></label></div>
                            <div class="toggle-row"><span class="toggle-label">对齐 INSERT 列</span><label class="toggle"><input type="checkbox" id="alignInsertColumns"><span class="toggle-slider"></span></label></div>
                            <div class="toggle-row"><span class="toggle-label">对齐 VALUES 组</span><label class="toggle"><input type="checkbox" id="alignInsertValuesGroups"><span class="toggle-slider"></span></label></div>
                            <div class="config-item">
                                <div class="ci-label"><span class="ci-label-text">IN 列表阈值</span><span class="ci-label-hint">超过换行</span></div>
                                <input type="number" class="config-input" id="maxItemsInlineList" min="1" max="100">
                            </div>
                            <div class="config-item">
                                <div class="ci-label"><span class="ci-label-text">CTE 逗号位置</span></div>
                                <select class="config-select" id="cteCommaPosition">
                                    <option value="before">行首</option>
                                    <option value="after">行尾</option>
                                </select>
                            </div>
                            <div class="config-item">
                                <div class="ci-label"><span class="ci-label-text">子查询括号风格</span></div>
                                <select class="config-select" id="subqueryParenStyle">
                                    <option value="inline">内联</option>
                                    <option value="newline">换行</option>
                                </select>
                            </div>
                            <div class="config-item">
                                <div class="ci-label"><span class="ci-label-text">注释位置策略</span></div>
                                <select class="config-select" id="commentPosition">
                                    <option value="preserve">保持原样</option>
                            ...
                            <div class="config-item">
                                <div class="ci-label"><span class="ci-label-text">UNION 前空行数</span></div>
                                <input type="number" class="config-input" id="blankLinesBeforeSetOperation" min="0" max="5">
                            </div>
                            <div class="config-item">
                                <div class="ci-label"><span class="ci-label-text">UNION 后空行数</span></div>
                                <input type="number" class="config-input" id="blankLinesAfterSetOperation" min="0" max="5">
                            </div>
                            <div class="toggle-row"><span class="toggle-label">LATERAL VIEW 前换行 (Hive)</span><label class="toggle"><input type="checkbox" id="newlineBeforeLateralView"><span class="toggle-slider"></span></label></div>
                            <div class="toggle-row"><span class="toggle-label">DISTRIBUTE BY 前换行 (Hive)</span><label class="toggle"><input type="checkbox" id="newlineBeforeDistributeBy"><span class="toggle-slider"></span></label></div>
                            <div class="toggle-row"><span class="toggle-label">CLUSTER BY 前换行 (Hive)</span><label class="toggle"><input type="checkbox" id="newlineBeforeClusterBy"><span class="toggle-slider"></span></label></div>
                            <div class="toggle-row"><span class="toggle-label">SORT BY 前换行 (Hive)</span><label class="toggle"><input type="checkbox" id="newlineBeforeSortBy"><span class="toggle-slider"></span></label></div>
                            <div class="toggle-row"><span class="toggle-label">CONNECT BY 前换行 (Oracle)</span><label class="toggle"><input type="checkbox" id="newlineBeforeConnectBy"><span class="toggle-slider"></span></label></div>
                            <div class="toggle-row"><span class="toggle-label">START WITH 前换行 (Oracle)</span><label class="toggle"><input type="checkbox" id="newlineBeforeStartWith"><span class="toggle-slider"></span></label></div>
    ...
    <script>
        ...
        const presets = {
            ...
            compact: {
                ...
                newlineBeforeConnectBy: false,
                newlineBeforeStartWith: false,
                ignoreTabSettings: false,
                tabSizeOverride: 2,
                insertSpacesOverride: true,
        ...
        function collectConfig() {
            return {
                ...
                newlineBeforeConnectBy: document.getElementById('newlineBeforeConnectBy').checked,
                newlineBeforeStartWith: document.getElementById('newlineBeforeStartWith').checked,
    ...
    private async _sendCurrentConfig() {
        ...
        this._panel.webview.postMessage({
            ...
            data: {
                ...
                newlineAfterGroupBy: config.get('newlineAfterGroupBy', true),
                newlineAfterHaving: config.get('newlineAfterHaving', true),
                newlineAfterOrderBy: config.get('newlineAfterOrderBy', true),
                newlineAfterLimit: config.get('newlineAfterLimit', false),
                newlineAfterJoin: config.get('newlineAfterJoin', true),
                newlineBeforeOn: config.get('newlineBeforeOn', true),
                newlineBeforeSetOperation: config.get('newlineBeforeSetOperation', true),
                newlineAfterCase: config.get('newlineAfterCase', true),
                newlineAfterWhen: config.get('newlineAfterWhen', true),
                newlineAfterThen: config.get('newlineAfterThen', false),
                newlineAfterElse: config.get('newlineAfterElse', false),
                newlineAfterIn: config.get('newlineAfterIn', false),
                ...
                nullCase: config.get('nullCase', 'preserve'),
                booleanCase: config.get('booleanCase', 'preserve'),
                indentJoinConditions: config.get('indentJoinConditions', true),
                indentWhen: config.get('indentWhen', true),
                indentThen: config.get('indentThen', true),
                indentCteBody: config.get('indentCteBody', true),
                alignOnClauses: config.get('alignOnClauses', false),
                alignInsertColumns: config.get('alignInsertColumns', false),
                alignInsertValuesGroups: config.get('alignInsertValuesGroups', false),
                maxItemsInlineList: config.get('maxItemsInlineList', 5),
                cteCommaPosition: config.get('cteCommaPosition', 'before'),
                subqueryParenStyle: config.get('subqueryParenStyle', 'inline'),
                commentPosition: config.get('commentPosition', 'preserve'),
                blankLinesBeforeSetOperation: config.get('blankLinesBeforeSetOperation', 1),
                blankLinesAfterSetOperation: config.get('blankLinesAfterSetOperation', 0),
                newlineBeforeLateralView: config.get('newlineBeforeLateralView', true),
                newlineBeforeDistributeBy: config.get('newlineBeforeDistributeBy', true),
                newlineBeforeClusterBy: config.get('newlineBeforeClusterBy', true),
                newlineBeforeSortBy: config.get('newlineBeforeSortBy', true),
                newlineBeforeConnectBy: config.get('newlineBeforeConnectBy', true),
                newlineBeforeStartWith: config.get('newlineBeforeStartWith', true),
    ...
    private async _updateConfig(data: Record<string, unknown>) {
        ...
        const entries: [string, unknown][] = [
            ...
            ['newlineAfterGroupBy', data.newlineAfterGroupBy],
            ['newlineAfterHaving', data.newlineAfterHaving],
            ['newlineAfterOrderBy', data.newlineAfterOrderBy],
            ['newlineAfterLimit', data.newlineAfterLimit],
            ['newlineAfterJoin', data.newlineAfterJoin],
            ['newlineBeforeOn', data.newlineBeforeOn],
            ['newlineBeforeSetOperation', data.newlineBeforeSetOperation],
            ['newlineAfterCase', data.newlineAfterCase],
            ['newlineAfterWhen', data.newlineAfterWhen],
            ['newlineAfterThen', data.newlineAfterThen],
            ['newlineAfterElse', data.newlineAfterElse],
            ['newlineAfterIn', data.newlineAfterIn],
            ...
            ['nullCase', data.nullCase],
            ['booleanCase', data.booleanCase],
            ['indentJoinConditions', data.indentJoinConditions],
            ['indentWhen', data.indentWhen],
            ['indentThen', data.indentThen],
            ['indentCteBody', data.indentCteBody],
            ['alignOnClauses', data.alignOnClauses],
            ['alignInsertColumns', data.alignInsertColumns],
            ['alignInsertValuesGroups', data.alignInsertValuesGroups],
            ['maxItemsInlineList', data.maxItemsInlineList],
            ['cteCommaPosition', data.cteCommaPosition],
            ['subqueryParenStyle', data.subqueryParenStyle],
            ['commentPosition', data.commentPosition],
            ['blankLinesBeforeSetOperation', data.blankLinesBeforeSetOperation],
            ['blankLinesAfterSetOperation', data.blankLinesAfterSetOperation],
            ['newlineBeforeLateralView', data.newlineBeforeLateralView],
            ['newlineBeforeDistributeBy', data.newlineBeforeDistributeBy],
            ['newlineBeforeClusterBy', data.newlineBeforeClusterBy],
            ['newlineBeforeSortBy', data.newlineBeforeSortBy],
            ['newlineBeforeConnectBy', data.newlineBeforeConnectBy],
            ['newlineBeforeStartWith', data.newlineBeforeStartWith],
